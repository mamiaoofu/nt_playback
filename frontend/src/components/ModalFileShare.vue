<template>
    ...
    <div v-if="showResult" class="modal-backdrop" id="fileShareResult">
        <div class="modal-box" style="max-width: 455px;">
            <div class="modal-header">
                <div style="display: flex; align-items: center; gap: 8px">
                ...
                <div v-if="resultType === 'ticket'">
                    ...
                    <div class="card card-detail-to" style="padding:16px; border:1px solid #e6eef8;">
                        ...
                        <div style="border:1px dashed #e6eef8; padding:12px; margin-bottom:12px;">
                            ...
                            <div v-if="resultData.limitAccessTimes !== null && resultData.limitAccessTimes !== undefined && resultData.limitAccessTimes !== ''" class="detail-file-share"><strong class="strong-title">Limit Access Times:</strong> {{ resultData.limitAccessTimes }}</div>
                        </div>
