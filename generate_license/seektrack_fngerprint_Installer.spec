...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('C:\\Users\\ACER\\Documents\\GitHub\\nt_playback\\generate_license\\output\\license.json', 'license_files'), ('C:\\Users\\ACER\\Documents\\GitHub\\nt_playback\\generate_license\\output\\public_key.pem', 'license_files'), ('C:\\Users\\ACER\\Documents\\GitHub\\nt_playback\\generate_license\\output\\fingerprint.txt', 'license_files'), ('C:\\Users\\ACER\\Documents\\GitHub\\nt_playback\\generate_license\\dist\\seektrack.exe', '.'), ('C:\\Users\\ACER\\Documents\\GitHub\\nt_playback\\generate_license\\images\\logo-nichtel.png', '.')],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
